-- =============================================================================================
-- DDL COMPLETO - TiendaLatam en SQL Server
-- Curso de SQL Server para Analistas de Datos
-- =============================================================================================
-- Descripción: Este script crea la base de datos TiendaLatam y define su esquema completo, con
-- 9 tablas, PKs, FKs, índices y restricciones
-- Motor: SQL Server
-- =============================================================================================
...
-- 1. USE para cambiar al contexto de la nueva base de datos
USE TiendaLatam;
GO

-- 2. DB_NAME() para verificar que estamos en la base de datos correcta
SELECT DB_NAME() AS BaseDeDatosActual;
GO

-- 3. CREACIÓN DE TABLAS, CLAVES PRIMARIAS, CLAVES FORÁNEAS, ÍNDICES Y RESTRICCIONES
...
-- 4. NONCLUSTERED INDEX para optimizar consultas por PaísID en Sucursales
